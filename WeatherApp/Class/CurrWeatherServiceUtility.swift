                ...
                if let urlContent =  data {
                    ...
                    do{
                        ...
                        let packagedWeather: NSDictionary = [
                            ...
                            "main" : "\(mainWeather!)",
                            "icon" : "\(icon!)",
                            "temp" : String(format: "%.2f", temp as! Double),
                            "min" : String(format: "%.2f", min as! Double),
                            "max" : String(format: "%.2f", max as! Double),
                            "clouds" : String(format: "%.1f", cloudAll as! Double),
                            "humidity" : String(format: "%.1f", humidity as! Double),
                            "pressure" : String(format: "%.2f", pressure as! Double),
                            "windSp" : String(format: "%.2f", windSp as! Double),
                            "windDeg" : String(format: "%.2f", windDeg as! Double),
